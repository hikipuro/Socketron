namespace Socketron.Electron {
	...
	public class BrowserWindowConstructorOptions {
		...
		/// <returns></returns>
		public static BrowserWindowConstructorOptions Parse(string text) {
			return JSON.Parse<BrowserWindowConstructorOptions>(text);
		}
	...
	/// <summary>
	/// BrowserWindow.setAppDetails() options.
	/// </summary>
	public class AppDetailsOptions {
		...
		/// <summary>
		/// Index of the icon in appIconPath.
		/// Ignored when appIconPath is not set. Default is 0.
		/// </summary>
		public int appIconIndex;
		public string relaunchCommand;
		public string relaunchDisplayName;
	}

	/// <summary>
	/// BrowserWindow.setIgnoreMouseEvents() options.
	/// </summary>
