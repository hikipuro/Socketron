...
namespace Socketron.Electron {
	...
	public class Dialog : JSObject {
		...
		/// <returns></returns>
		public string[] showOpenDialog(OpenDialogOptions options) {
			return showOpenDialog(null, options);
		}

		public string[] showOpenDialog(BrowserWindow browserWindow, OpenDialogOptions options) {
			object[] result = null;
		...
		public string[] showOpenDialog(OpenDialogOptions options, Action<string[], string[]> callback) {
		...
		/// <param name="options"></param>
		/// <returns></returns>
		public string showSaveDialog(SaveDialogOptions options) {
			return showSaveDialog(null, options);
		}

		public string showSaveDialog(BrowserWindow browserWindow, SaveDialogOptions options) {
			if (browserWindow == null) {
		...
		public string showSaveDialog(SaveDialogOptions options, Action<string, string> callback) {
		...
		public int showMessageBox(BrowserWindow browserWindow, MessageBoxOptions options) {
			if (browserWindow == null) {
